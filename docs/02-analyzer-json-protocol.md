...
- 协议 v2 当前是 `DRAFT`，设计初稿见 [报告协议 v2](protocol/analyzer-report-v2.md)，字段迁移见 [v1 到 v2 迁移方案](protocol/analyzer-report-v2-migration.md)。在双方真实评审、独立实现和默认版本切换任务完成前，本文件中的 v1 仍是唯一已实现且默认输出的协议。
